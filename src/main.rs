...
use inquire::Select;
use problem::{
    amicable_numbers::AmicableNumbersProblem, bouncy_numbers::BouncyNumbersProblem,
    champernownes_constant::ChampernownesConstantProblem, circular_primes::CircularPrimesProblem,
    coded_triangle_numbers::CodedTriangleNumbersProblem, coin_partitions::CoinPartitionsProblem,
    coin_sums::CoinSumProblem, combinatoric_selections::CombinatoricSelectionsProblem,
    concealed_squares::ConcealedSquaresProblem,
    consecutive_positive_divisors::ConsecutivePositiveDivisorsProblem,
    consecutive_prime_sum::ConsecutivePrimeSumProblem, convergents_of_e::ConvergentsOfEProblem,
    counting_fractions::CountingFractionsProblem,
    counting_fractions_in_a_range::CountingFractionsInARangeProblem,
    counting_rectangles::CountingRectanglesProblem, counting_summations::CountingSummationsProblem,
    counting_sundays::CountingSundaysProblem, digit_factorial_chains::DigitFactorialChainsProblem,
    digit_factorials::DigitFactorialsProblem, digit_fifth_powers::DigitFifthPowersProblem,
    distinct_powers::DistinctPowersProblem, distinct_prime_factors::DistinctPrimeFactorsProblem,
    double_base_palindrome::DoubleBasePalindromeProblem,
    efficient_exponentiation::EfficientExponentiationProblem, even_fibonacci::EvenFibonacciProblem,
    ...
    large_non_mersenne_prime::LargeNonMersennePrimeProblem, large_sum::LargeSumProblem,
    largest_exponential::LargestExponentialProblem,
    largest_palindrome_product::LargestPalindromeProduct,
    largest_prime_factor::LargestPrimeFactorProblem, largest_product::LargestProductProblem,
    largest_product_in_a_grid::LargestProductInAGridProblem,
    laser_beam_reflections::LaserBeamReflectionsProblem, lattice_paths::LatticePathsProblem,
    lexicographic_permutations::LexicographicPermutationsProblem,
    longest_collatz_sequence::LongestCollatzSequenceProblem,
    lychrel_numbers::LychrelNumbersProblem, maximum_path_sum_one::MaximumPathSumOneProblem,
    maximum_path_sum_two::MaximumPathSumTwoProblem, multiples::MultiplesProblem,
    names_scores::NamesScoresProblem, non_abundant_sums::NonAbundantSumsProblem,
    non_bouncy_numbers::NonBouncyNumbersProblem, number_letter_counts::NumberLetterCountsProblem,
    number_power_spirals::NumberPowerSpiralsProblem,
    odd_period_square_roots::OddPeriodSquareRootsProblem,
    ordered_fractions::OrderedFractionsProblem, ordered_radicals::OrderedRadicalsProblem,
    pandigital_multiples::PandigitalMultiplesProblem, pandigital_prime::PandigitalPrimeProblem,
    pandigital_products::PandigitalProductsProblem, passcode_derivation::PasscodeDerivationProblem,
    path_sum_four_ways::PathSumFourWaysProblem, path_sum_three_ways::PathSumThreeWaysProblem,
    path_sum_two_ways::PathSumTwoWaysProblem, permuted_multiples::PermutedMultiplesProblem,
    power_digit_sum::PowerDigitSum, powerful_digit_counts::PowerfulDigitCountsProblem,
    powerful_digit_sum::PowerfulDigitSumProblem, prime_10001::NthPrimeProblem,
    prime_permutations::PrimePermutationsProblem, prime_summations::PrimeSummationsProblem,
    reciprocal_cycles::ReciprocalCyclesProblem, reversible_numbers::ReversibleNumbersProblem,
    roman_numerals::RomanNumeralsProblem, self_powers::SelfPowersProblem,
    semiprimes::SemiprimesProblem, smallest_multiple::SmallestMultipleProblem,
    special_pythagorean_triplet::SpecialPythagoreanTripletProblem,
    spiral_primes::SpiralPrimesProblem, square_digit_chains::SquareDigitChainsProblem,
    square_root_convergents::SquareRootConvergentsProblem,
    sum_of_squares_of_divisors::SumOfSquaresOfDivisorsProblem,
    sum_square_difference::SumSquareDifference, summation_of_primes::SummationOfPrimes,
    ...
    triangular_pentagonal_hexagonal::TriangularPentagonalHexagonalNumberProblem, Problem,
};
